...
<h1><div class="box"><div class="leftbox"><div class="h1"><strong>HRS</strong>
   ...
   <div class="right" >My appointment
      <div class="text"><button class="accordion" style="width: 550px;">Appointment 1&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;DoctorName&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Time</button><div class="panel" style="text-align: left;"><p>Appointment&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;NO.XXXXXX<br>Data:  XX/XX/XX<br>Time: XX/XX XX<br>Doctor: XXX<br>Department: XXXXXXXX<br>Address: XXXXXXXXX<br><input type="button" value="Cancel" style="width: 100px; font-size: 50px;"></p></div>
       <br>
       <button class="accordion" style="width: 550px;">Appointment 2&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;DoctorName&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Time</button><div class="panel" style="text-align: left;"><p>Appointment&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;NO.XXXXXX<br>Data:  XX/XX/XX<br>Time: XX/XX XX<br>Doctor: XXX<br>Department: XXXXXXXX<br>Address: XXXXXXXXX<br><input type="button" value="Cancel" style="width: 100px; font-size: 50px;"></p></div>
          <br>
       <button class="accordion" style="width: 550px;">Appointment 3&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;DoctorName&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Time</button><div class="panel" style="text-align: left;"><p>Appointment&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;NO.XXXXXX<br>Data:  XX/XX/XX<br>Time: XX/XX XX<br>Doctor: XXX<br>Department: XXXXXXXX<br>Address: XXXXXXXXX<br><input type="button"  value="Cancel" style="width: 100px; font-size: 50px;"></p></div>
          <script>
